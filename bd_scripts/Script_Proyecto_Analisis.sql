CREATE DATABASE  IF NOT EXISTS `compuequip_dos` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `compuequip_dos`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: compuequip_dos
-- ------------------------------------------------------
...
-- Dump completed on 2023-01-19 11:29:15
...
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: localhost    Database: darsdbstg
-- ------------------------------------------------------
-- Server version	8.0.28
...
--
-- Table structure for table `proceso_etl`
--

DROP TABLE IF EXISTS `proceso_etl`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `proceso_etl` (
  `CODIGO_ETL` bigint NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`CODIGO_ETL`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `proceso_etl`
--

LOCK TABLES `proceso_etl` WRITE;
/*!40000 ALTER TABLE `proceso_etl` DISABLE KEYS */;
/*!40000 ALTER TABLE `proceso_etl` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2023-01-19 15:29:01
